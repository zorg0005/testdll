...
typedef HGREN (SX_STDCALL * sol_CreateGrammarEngineW_Fun)( const wchar_t *DictionaryXml );
typedef HGREN (SX_STDCALL * sol_CreateGrammarEngineExW_Fun)( const wchar_t *DictionaryXml, int Flag );
